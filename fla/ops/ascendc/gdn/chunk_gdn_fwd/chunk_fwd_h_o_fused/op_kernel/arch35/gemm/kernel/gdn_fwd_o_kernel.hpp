...
public:
    ...
    __aicore__ inline void Init(GM_ADDR q, GM_ADDR k, GM_ADDR v, GM_ADDR h, GM_ADDR g,
        ...
        producerCoreNum = tilingData->producerCoreNum;
        activeCoreNum = tilingData->activeCoreNum;
        ...
        if ASCEND_IS_AIC {
            ...
            while (cubeBlockScheduler.isRunning) {
                ...
                if (needRun && coreIdx < coreNum) {
                    ...
                    // Cube2 runs while Vec1 computes QK * mask and waits for
                    // VReady. L0 resources remain serialized before Cube3.
                    if (cube2Offsets.vBlockDim <= 128) {
